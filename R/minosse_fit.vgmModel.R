...
#' @importFrom sp is.projected proj4string coordinates areaSpatialGrid
#' @importFrom stats runif 
#' 
#' 
minosse_fit.vgmModel<-function(formulaString, rmatrix, predictionDomain, vgmFun = "Exp", dimensions = list("2D", "3D", "2D+T", "3D+T"), anis = NULL, subsample = nrow(rmatrix), ivgm, cutoff = NULL, width = cutoff/15, cressie = FALSE, ...){
